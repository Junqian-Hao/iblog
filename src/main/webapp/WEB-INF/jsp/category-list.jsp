...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 博客系统 <span
            class="c-gray en">&gt;</span> 分类管理<a class="btn btn-success radius r"
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l">
                ...
                <a href="javascript:;"
                   onclick="member_add('添加用户','category-add.html','300','200')"
...
<script type="text/javascript">
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            var uid = $(obj).parents("tr").find("#cid").html();
            $.ajax({
                type: 'post',
                url: "${pageContext.request.contextPath}/ms/deleteCategory",
                cache: false,
                method: "POST",
                headers: {
